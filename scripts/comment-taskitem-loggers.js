...
const filePath = 'src/renderer/components/tasks/TaskItem.tsx'
...
for (let i = 0; i < lines.length; i++) {
  ...
  // Check if this line contains a logger or rendererLogger call
  if (!inLoggerCall && (line.includes('logger.') || line.includes('rendererLogger.')) && !line.includes('import')) {
    inLoggerCall = true
    parenDepth = 0
...
console.log(`\n✅ Done! Commented ${modifiedCount} logger calls in TaskItem.tsx`)
