...
INSERT INTO "new_Task" ("actualDuration", "asyncWaitTime", "completed", "completedAt", "createdAt", "criticalPathDuration", "currentStepId", "deadline", "dependencies", "duration", "hasSteps", "id", "importance", "isLocked", "lockedStartTime", "name", "notes", "overallStatus", "projectId", "sessionId", "type", "updatedAt", "urgency", "worstCaseDuration") SELECT "actualDuration", "asyncWaitTime", "completed", "completedAt", "createdAt", "criticalPathDuration", "currentStepId", "deadline", "dependencies", "duration", "hasSteps", "id", "importance", "isLocked", "lockedStartTime", "name", "notes", "overallStatus", "projectId", "sessionId", "type", "updatedAt", "urgency", "worstCaseDuration" FROM "Task";
DROP TABLE "Task";
